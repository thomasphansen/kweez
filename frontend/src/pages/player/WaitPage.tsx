...
export default function WaitPage() {
  ...
  const { playerSession, sessionState, isConnected, connect, joinSession } = useSession()
  ...
  useEffect(() => {
    ...
    if (!isConnected) {
      connect().then(() => {
        joinSession(playerSession.participantId)
      })
    }
  }, [playerSession, isConnected, connect, joinSession, navigate])
